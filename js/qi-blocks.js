    ...
    (()=>{
        ...
        const i = {
          ...
          , r = {
            ...
            init: function(e, t) {
                e && (r.document = e);
                const o = e || document;
                this.holder = o.querySelectorAll(".qodef-block .qodef-block-swiper"),
                this.holder.length && [...this.holder].map((e=>{
                    r.initItem(e, t)
                }
                ))
            },
            getRealCurrentItem: function(e) {
                return "string" == typeof e && "" !== e && (e = qiBlocksEditor.qodefGetCurrentBlockElement.get(e, "> .qodef-block .qodef-block-swiper", !0)),
                e
            },
            initItem: function(e, t) {
                if (e = r.getRealCurrentItem(e),
                t || (r.document = document),
                r.document?.body?.classList.contains("wp-admin") && (r.isEditorMode = !0),
                !e)
                    return;
                const o = !!r.isEditorMode && qiBlocksEditor.qodefGetCurrentBlockElement.getIframe();
                let i = e;
                ...
                i.forEach((e=>{
                    n.qodefWaitForImages.check(e, (function() {
                        setTimeout((()=>{
                            const o = r.getOptions(e)
                              , i = r.getEvents(e, o);
                            void 0 !== e && "object" == typeof e.swiper && t && e.swiper.destroy(),
                            new Swiper(e,Object.assign(o, i))
                        }
                        ), o ? 800 : 200)
                    }
                    ))
            ...
            getOptions: function(e) {
                let t = void 0 !== e.getAttribute("data-options") ? JSON.parse(e.getAttribute("data-options")) : {}
                  ...
                  , l = void 0 !== t.spaceBetweenTablet && "" !== t.spaceBetweenTablet ? t.spaceBetweenTablet : s
                  ...
                  , m = void 0 !== t.speedAnimation && "" !== t.speedAnimation ? parseInt(t.speedAnimation, 10) : 800
                  , h = void 0 !== t.customStages && "" !== t.customStages && t.customStages
                ...
                let B = void 0 !== t.slidesPerView1440 && "" !== t.slidesPerView1440 ? parseInt(t.slidesPerView1440, 10) + i : "auto" === t.slidesPerView ? "auto" : 5 + i
                  , E = void 0 !== t.slidesPerView1366 && "" !== t.slidesPerView1366 ? parseInt(t.slidesPerView1366, 10) + i : "auto" === t.slidesPerView ? "auto" : 4 + i
                  , I = void 0 !== t.slidesPerView1024 && "" !== t.slidesPerView1024 ? parseInt(t.slidesPerView1024, 10) + i : "auto" === t.slidesPerView ? "auto" : 3 + i
                  , S = void 0 !== t.slidesPerView768 && "" !== t.slidesPerView768 ? parseInt(t.slidesPerView768, 10) + i : "auto" === t.slidesPerView ? "auto" : 2 + i
                  , P = void 0 !== t.slidesPerView680 && "" !== t.slidesPerView680 ? parseInt(t.slidesPerView680, 10) + i : "auto" === t.slidesPerView ? "auto" : 1 + i
                  , V = void 0 !== t.slidesPerView480 && "" !== t.slidesPerView480 ? parseInt(t.slidesPerView480, 10) + i : "auto" === t.slidesPerView ? "auto" : 1 + i;
                if (r.isEditorMode && (r.document?.body?.classList.contains("qi-preview-screen-tablet") && (d = d < 3 ? d : I,
                s = l),
                r.document?.body?.classList.contains("qi-preview-screen-mobile") && (d = V,
                s = a)),
                h || (d < 2 ? (B = d,
                E = d,
                I = d,
                ...
                "never" !== n)
                    ...
                    case 1024:
                        I = Math.floor(I),
                        r.isEditorMode && r.document?.body.classList.contains("qi-preview-screen-tablet") && (d = Math.floor(d < 3 ? d : I));
                        break;
                    case 768:
                        S = Math.floor(S);
                        break;
                    ...
                    case 480:
                        V = Math.floor(V),
                        r.isEditorMode && r.document?.body.classList.contains("qi-preview-screen-mobile") && (d = Math.floor(V))
                    }
                let L = {
                    direction: o,
                    slidesPerView: d,
                    ...
                    grabCursor: !0,
                    simulateTouch: !r.isEditorMode && q,
                    breakpoints: {
                        0: {
                            slidesPerView: V,
                            spaceBetween: a
                ...
                return Object.assign(L, r.getSliderDatas(e))
            },
            getSliderDatas: function(e) {
                let t = o()(e).data()
                  , i = {};
                for (let e in t)
                    Object.prototype.hasOwnProperty.call(t, e) && "options" !== e && void 0 !== t[e] && "" !== t[e] && (i[e] = t[e]);
                return i
            },
                    ...
                    on: {
                        beforeInit: function() {
                            if ("vertical" === t.direction) {
                                ...
                                1 === t.slidesPerView && (e.style.height = o + "px",
                                n.length && n.forEach((e=>{
                                    e.style.height = o + "px"
                                }
                                )))
                        ...
                        init: function() {
                            if (e.classList.add("qodef--initialized"),
                            r.isEditorMode ? "object" == typeof qiBlocksEditor.qodefSetEditorLinkBehavior && qiBlocksEditor.qodefSetEditorLinkBehavior.linkBehavior(e.querySelectorAll("a, button")) : qiBlocks?.qodefLightboxPopup && qiBlocks.qodefLightboxPopup.init(e.parentNode),
                            "object" != typeof qiBlocksEditor && t.sliderScroll) {
                                let i = !1
                                  , n = o()(e)
                                  , s = e.classList.contains("qodef-block") ? n : n.parents(".qodef-block")
                                  , l = s.hasClass("qodef--focus-in-viewport")
                                  , r = s.offset().top
                                  , a = s.offset().top + s.outerHeight();
                                l && window.addEventListener("wheel", (function(e) {
                                    let t = o()(window).scrollTop() + e.deltaY;
                                    (e.deltaY > 0 && t < r || e.deltaY < 0 && a < t + qiBlocks.windowHeight) && qiBlocks.qodefIsInViewport.check(s, (function() {
                                        qiBlocks.qodefScroll.disable(),
                                ...
                                n.off().on("wheel", (function(n) {
                                    t.loop ? n.preventDefault() : ((n.originalEvent.deltaY < 0 && !e.swiper.isBeginning || n.originalEvent.deltaY > 0 && !e.swiper.isEnd) && n.preventDefault(),
                                    l && (n.originalEvent.deltaY < 0 && e.swiper.isBeginning ? (qiBlocks.qodefScroll.disable(),
                                    o()("html, body").stop().animate({
                                        scrollTop: Math.max(0, r - qiBlocks.windowHeight)
                                    }, 1200, (function() {
                                        qiBlocks.qodefScroll.enable()
                                    }
                                    ))) : n.originalEvent.deltaY > 0 && e.swiper.isEnd && (qiBlocks.qodefScroll.disable(),
                                    o()("html, body").stop().animate({
                                        scrollTop: a
                                    }, 1200, (function() {
                                        qiBlocks.qodefScroll.enable()
                                    ...
                                    i || (i = !0,
                                    n.originalEvent.deltaY > 0 ? e.swiper.slideNext() : e.swiper.slidePrev(),
                                    setTimeout((function() {
                                        i = !1
                                    }
                                    ), 1e3))
          ...
          , d = {
            ...
            isEditorMode: !1,
            init: function() {
                this.holder = document.querySelectorAll(".qodef-gutenberg-masonry-layout"),
                this.holder.length && [...this.holder].map((e=>{
                    d.createMasonry(e)
                }
                ))
            ...
            reLayout: function() {
                ...
                "object" == typeof e && Object.keys(e).length && Object.values(e).map((e=>{
                    setTimeout((()=>{
                        ...
                        e.element.parentNode.classList.contains("qodef-items--fixed") && d.setFixedImageSize(e.element, t[0], o, i)),
                        setTimeout((()=>{
                            e.layout()
                        }
                        ), 400)
            ...
            getRealCurrentItem: function(e) {
                return "string" == typeof e && "" !== e && (e = qiBlocksEditor.qodefGetCurrentBlockElement.get(e, "> .qodef-block .qodef-gutenberg-masonry-layout")),
                e
            },
            initItem: function(e, t) {
                const o = t ? e : "";
                (e = d.getRealCurrentItem(e)) && (document.body.classList.contains("wp-admin") && (d.isEditorMode = !0),
                o && d.masonry[o] && e ? d.reInit(e, o, t) : d.createMasonry(e, o))
            },
            ...
            createMasonryLogic: function(e, t, o, i) {
                if ("function" == typeof Isotope && (d.isEditorMode || !t.classList.contains("qodef--masonry-init"))) {
                    const n = t.querySelectorAll(".qodef-gutenberg-column")
                      ...
                      , l = parseInt(window.getComputedStyle(t).getPropertyValue("column-gap"), 10);
                    n.forEach((e=>{
                        e.style.width = s + "px"
                    }
                    )),
                    e.classList.contains("qodef-items--fixed") && d.setFixedImageSize(t, o, s, l);
                    const r = new Isotope(t,{
                        layoutMode: "packery",
                    ...
                    ), d.isEditorMode ? 600 : 0),
                    t.classList.contains("qodef--masonry-init") || t.classList.add("qodef--masonry-init")
                }
            },
            setFixedImageSize: function(e, t, o, i) {
                const n = d.isEditorMode ? document.body.classList.contains("qi-preview-screen-tablet") || document.body.classList.contains("qi-preview-screen-mobile") : qiBlocks.windowWidth <= 680
                  ...
                  , l = e.querySelectorAll(".qodef-gutenberg-column");
                l && l.forEach((e=>{
                    let t = o
                      , l = o;
                    s ? (e.classList.contains("qodef-item--landscape") && (l = Math.round(o / 2)),
                    e.classList.contains("qodef-item--portrait") && (l = Math.round(2 * o))) : (e.classList.contains("qodef-item--landscape") && (t = Math.round(2 * o + i),
                    n && (t = Math.round(o),
                    l = Math.round(o / 2))),
                    e.classList.contains("qodef-item--portrait") && (l = Math.round(2 * o + i)),
                    e.classList.contains("qodef-item--huge-square") && (t = Math.round(2 * o + i),
                    l = Math.round(2 * o + i),
                    n && (t = Math.round(o),
                    l = Math.round(o)))),
                    e.style.width = t + "px",
        ...
        var u = {
            init: function(e) {
                ...
                ), 2e3) : (this.holder = document.querySelectorAll(".qi-block-fslightbox-popup"),
                this.holder.length && [...this.holder].map((e=>{
                    u.initItem(e)
                }
                )))
            ...
            getRealCurrentItem: function(e) {
                return "string" == typeof e && "" !== e && (e = qiBlocksEditor.qodefGetCurrentBlockElement.get(e)),
                e
            },
            initItem: function(e, t) {
                if (e = u.getRealCurrentItem(e)) {
                    refreshFsLightbox();
                    for (const e in fsLightboxInstances)
                        fsLightboxInstances[e].props.onInit = ()=>{
                            ...
                            o.length && (o[0].innerHTML = s.vars.arrowLeftIcon),
                            i.length && (i[0].innerHTML = s.vars.arrowRightIcon),
                            n.length && (n[0].innerHTML = s.vars.closeIcon)
                        }
                }
            }
        };
        const f = u
          , p = {
            init: function() {
                this.holder = document.querySelectorAll(".qodef-image--hover-follow-info"),
                this.holder.length && [...this.holder].map((e=>{
                    p.initItem(e)
                }
                ))
            ...
            initItemBehavior: function(e) {
                if (e) {
                    ...
                    t && e.addEventListener("mousemove", (e=>{
                        e.clientX + t.offsetWidth + 20 > window.innerWidth ? t.classList.add("qodef--right") : t.classList.remove("qodef--right"),
          ...
          , w = p;
        void 0 === window.qiBlocks && (window.qiBlocks = {}),
        qiBlocks.body = o()("body"),
        qiBlocks.html = o()("html"),
        qiBlocks.windowWidth = o()(window).width(),
        qiBlocks.windowHeight = o()(window).height(),
        qiBlocks.scroll = 0,
        qiBlocks.qodefScroll = n,
        qiBlocks.qodefIsInViewport = s,
        qiBlocks.qodefWaitForImages = l,
        qiBlocks.qodefSwiper = a,
        qiBlocks.qodefMasonryLayout = c,
        qiBlocks.qodefLightboxPopup = f,
        ...
        const g = {
            ...
            setClasses: function(e) {
                e.classList.contains("qodef-animation--appeared") || qiBlocks.qodefIsInViewport.check(e, (function() {
                    e.classList.add("qodef-animation--appeared"),
                    e.getAttribute("data-animation") && e.classList.add("animate__" + e.getAttribute("data-animation"))
                }
                ))
            }
        };
